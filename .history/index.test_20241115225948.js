...
const { app } = require('./index'); // Import the app and server
...
describe('Product API', () => {
    it('GET /products should return a list of products with the required properties', async () => {
        ...
        const response = await request(server).get('/products'); // Send GET request to /products
